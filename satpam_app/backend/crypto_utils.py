...
class HybridCrypto:
    ...
    def decrypt_data(self, encrypted_data_b64, symmetric_key):
        ...
        # encrypted_data_b64 is already a base64url string, and Fernet.decrypt expects a base64url string/bytes.
        decrypted_data = f.decrypt(encrypted_data_b64)
        return decrypted_data.decode('utf-8')

    def hybrid_decrypt(self, encrypted_data_b64, encrypted_key_b64):
        """Perform full hybrid decryption: decrypt key via RSA, then data via Fernet."""
